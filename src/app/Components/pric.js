      ...
      <div className="grid grid-cols-3 place-items-center mt-20 max-sm:grid-cols-1 gap-10">
        ...
        {array.map((data, index) => (
          ...
          >
            ...
            <p className="text-center font-bold text-xl">Plan 1</p>
            <hr />
            <h1 className="text-center font-bold text-4xl my-5">
              ${index * 340}
            </h1>
            <h1 className="text-center font-bold text-xl my-5">/month</h1>
            <p className="text-center">
              Level-up with more power and enhanced features
            </p>
            <button className="bg-blue-500 text-white font-bold capitalize w-[240px] px-4 py-3 rounded-3xl m-auto block mt-10">
              get now
            </button>
            <hr className="mt-10" />
            <ul className="text-left mt-40 max-sm:mt-10 ">
              <li className="pricing_list my-3 flex justify-between items-center ">
                {" "}
                this is my pricing text{" "}
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
