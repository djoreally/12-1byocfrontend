...
import InsightsDashboard from '@/app/Components/SuperAdmin/InsightsDashboard';

// This page will essentially be the same as the InsightsPage for now,
// serving as the main landing for the SuperAdmin section.
