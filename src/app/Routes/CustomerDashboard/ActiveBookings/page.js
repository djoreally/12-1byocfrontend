  ...
  return (
    <div className="mt-10 max-sm:mx-5">
      ...
      <div className="grid grid-cols-3 gap-5 mt-5 max-sm:grid-cols-1 ">
        {data?.Bookings?.filter((booking) => booking?.status === "pending").map(
          (data, index) => (
            <div key={index} className="bg-white p-4 rounded-xl grid grid-cols-1  ">
      ...
      >
        <div className="grid grid-cols-2 mb-5 gap-10 max-sm:grid-cols-1">
          ...
          <div className="flex justify-between max-sm:flex-wrap bg-white p-4 rounded-sm">
            <div>
              <div className="flex items-center gap-1">
                <Image
                  src={bookingdata?.provider?.Logo}
                  width={100}
                  height={100}
                  className="w-10 h-10 rounded-full"
                />
                <p className="text-lg capitalize font-semibold text-gray-900">
                  {bookingdata?.provider?.StoreName}
                </p>
              </div>
              <p className="flex items-center gap-1 text-sm font-medium my-2">
                <svg
                ...
                {bookingdata?.provider?.user?.email}
              </p>
              <p className="flex items-center gap-1 text-sm font-medium my-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                {bookingdata?.provider?.user?.phone}
              </p>
              <p className="flex items-center gap-1 text-sm font-medium my-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
        ...
        <div>
          <div  className="grid grid-cols-6 max-sm:hidden bg-white my-1 gap-x-6 px-2 p-4 rounded-lg ">
          ...
          {bookingdata?.selectedService?.map((data, index) => (
            <div key={index/4} className="">
              <div className="grid grid-cols-6 max-sm:grid-cols-1 bg-white my-5 gap-x-6 px-2 p-4 rounded-lg border-l-8 border-lime-400">
        ...
        <hr />
        <div className="flex items-center justify-between max-sm:mr-2 mr-20 uppercase mt-4">
